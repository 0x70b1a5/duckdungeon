...
impl State {
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ctx.set_active_console(2);
        ctx.print_color_centered(2, GREEN, BLACK, "You've found the Duckington Amulet!");
        ctx.print_color_centered(4, WHITE, BLACK, "You don the amulet and its INCREDBILE POWER waddles through your veins.");
        ctx.print_color_centered(6, GREEN, BLACK, "Press 1 to play again.");
